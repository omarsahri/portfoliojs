export const portfolio = {
  ...
  projects: [
    ...
    },
    {
      ...
      category: "Training",
      description: "EWI-certified industrial robotics training in FANUC and DOOSAN programming, PLC/HMI integration, and safety systems—building hands-on skills for real-world deployment.",
      period: "Sep 2023 - Dec 2024",
      location: "Paris, France",
      image: "/projects/industrial-robots-1.png",
      caseStudy: {
        challenge: "Integrating industrial robots into production lines requires maintaining productivity and worker safety while connecting legacy systems with modern robotic platforms. I pursued formal training to build these competencies before deployment in the field.",
        solution: "Completed EWI-certified training in FANUC and DOOSAN robot programming. Developed custom robot programs for material handling and assembly operations. Integrated robots with PLCs and HMI systems for seamless operation. Implemented safety protocols and conducted thorough testing in a lab environment.",
        technologies: ["FANUC", "DOOSAN", "PLC Programming", "HMI"],
        features: [
        ...
        results: [
          "Hands-on practice integrating multiple industrial robots in training cells",
          "Trained on throughput optimization and safety scenarios",
          "Practiced safety protocols and manual handling risk reduction",
          "Applied maintenance and uptime best practices in lab exercises",
        ],
        images: [
          "/projects/industrial-robots-1.png",
          "/projects/industrial-robots-2.png",
          "/projects/industrial-robots-3.png",
        ],
      },
    },
  ],
