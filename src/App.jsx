      ...
      <section className="section contact" id="contact">
        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <p><strong>Email</strong><br /><a href={`mailto:${portfolio.email}`}>{portfolio.email}</a></p>
            <p><strong>Phone</strong><br /><a href={`tel:${portfolio.phone.replace(/\s/g, '')}`}>{portfolio.phone}</a></p>
            <p><strong>Location</strong><br />{portfolio.location}</p>
